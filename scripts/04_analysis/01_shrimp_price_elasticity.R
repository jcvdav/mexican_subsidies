...
nev3 <- feols(log(fuel_consumption_l) ~ log(p) + total_hp + nino34_m | eu, shrimp_panel, subset = ~!treated & year >= 2017)
nev4 <- feols(log(fuel_consumption_l) ~ log(p_stat) + total_hp + nino34_m | eu, data = shrimp_panel, subset = ~!treated & year >= 2017)
nev5 <- feols(log(fuel_consumption_l) ~ log(p_stat) + total_hp | eu + year, data = shrimp_panel, subset = ~!treated & year >= 2017)
...
loglin_nev3 <- feols(log(fuel_consumption_l) ~ p + total_hp + nino34_m | eu, shrimp_panel, subset = ~!treated & year >= 2017)
loglin_nev4 <- feols(log(fuel_consumption_l) ~ p_stat + total_hp + nino34_m | eu, data = shrimp_panel, subset = ~!treated & year >= 2017)
loglin_nev5 <- feols(log(fuel_consumption_l) ~ p_stat + total_hp | eu + year, data = shrimp_panel, subset = ~!treated & year >= 2017)
